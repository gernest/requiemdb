...
class Span$Type extends MessageType<Span> {
    constructor() {
        super("opentelemetry.proto.trace.v1.Span", [
            ...
            { no: 7, name: "start_time_unix_nano", kind: "scalar", T: 6 /*ScalarType.FIXED64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 8, name: "end_time_unix_nano", kind: "scalar", T: 6 /*ScalarType.FIXED64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<Span>): Span {
        const message = { traceId: new Uint8Array(0), spanId: new Uint8Array(0), traceState: "", parentSpanId: new Uint8Array(0), flags: 0, name: "", kind: 0, startTimeUnixNano: 0n, endTimeUnixNano: 0n, attributes: [], droppedAttributesCount: 0, events: [], droppedEventsCount: 0, links: [], droppedLinksCount: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Span_Event$Type extends MessageType<Span_Event> {
    ...
    create(value?: PartialMessage<Span_Event>): Span_Event {
        const message = { timeUnixNano: 0n, name: "", attributes: [], droppedAttributesCount: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
