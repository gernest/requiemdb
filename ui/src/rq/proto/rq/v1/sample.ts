...
class Sample$Type extends MessageType<Sample> {
    constructor() {
        super("v1.Sample", [
            ...
            { no: 2, name: "min_ts", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 3, name: "max_ts", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 4, name: "date", kind: "scalar", T: 4 /*ScalarType.UINT64*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 min_ts */ 2:
                    message.minTs = reader.uint64().toString();
                    break;
                case /* uint64 max_ts */ 3:
                    message.maxTs = reader.uint64().toString();
                    break;
                case /* uint64 date */ 4:
