...
class Sample$Type extends MessageType<Sample> {
    constructor() {
        super("v1.Sample", [
            ...
            { no: 2, name: "min_ts", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 3, name: "max_ts", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ },
            { no: 4, name: "date", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 2 /*LongType.NUMBER*/ }
        ]);
    }
    create(value?: PartialMessage<Sample>): Sample {
        const message = { data: new Uint8Array(0), minTs: 0, maxTs: 0, date: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 min_ts */ 2:
                    message.minTs = reader.uint64().toNumber();
                    break;
                case /* uint64 max_ts */ 3:
                    message.maxTs = reader.uint64().toNumber();
                    break;
                case /* uint64 date */ 4:
                    message.date = reader.uint64().toNumber();
                    break;
                default:
