...
class NumberDataPoint$Type extends MessageType<NumberDataPoint> {
    constructor() {
        super("opentelemetry.proto.metrics.v1.NumberDataPoint", [
            ...
            { no: 6, name: "as_int", kind: "scalar", oneof: "value", T: 16 /*ScalarType.SFIXED64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<NumberDataPoint>): NumberDataPoint {
        const message = { attributes: [], startTimeUnixNano: 0n, timeUnixNano: 0n, value: { oneofKind: undefined }, exemplars: [], flags: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class HistogramDataPoint$Type extends MessageType<HistogramDataPoint> {
    constructor() {
        super("opentelemetry.proto.metrics.v1.HistogramDataPoint", [
            ...
            { no: 6, name: "bucket_counts", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 6 /*ScalarType.FIXED64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<HistogramDataPoint>): HistogramDataPoint {
        const message = { attributes: [], startTimeUnixNano: 0n, timeUnixNano: 0n, count: 0n, bucketCounts: [], explicitBounds: [], exemplars: [], flags: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ExponentialHistogramDataPoint$Type extends MessageType<ExponentialHistogramDataPoint> {
    ...
    create(value?: PartialMessage<ExponentialHistogramDataPoint>): ExponentialHistogramDataPoint {
        const message = { attributes: [], startTimeUnixNano: 0n, timeUnixNano: 0n, count: 0n, scale: 0, zeroCount: 0n, flags: 0, exemplars: [], zeroThreshold: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ExponentialHistogramDataPoint_Buckets$Type extends MessageType<ExponentialHistogramDataPoint_Buckets> {
    constructor() {
        super("opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets", [
            ...
            { no: 2, name: "bucket_counts", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class SummaryDataPoint$Type extends MessageType<SummaryDataPoint> {
    ...
    create(value?: PartialMessage<SummaryDataPoint>): SummaryDataPoint {
        const message = { attributes: [], startTimeUnixNano: 0n, timeUnixNano: 0n, count: 0n, sum: 0, quantileValues: [], flags: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Exemplar$Type extends MessageType<Exemplar> {
    constructor() {
        super("opentelemetry.proto.metrics.v1.Exemplar", [
            ...
            { no: 2, name: "time_unix_nano", kind: "scalar", T: 6 /*ScalarType.FIXED64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<Exemplar>): Exemplar {
        const message = { filteredAttributes: [], timeUnixNano: 0n, value: { oneofKind: undefined }, spanId: new Uint8Array(0), traceId: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
