...
func (x *Scan_BaseFilter) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Scan_AttrFilter) GetKey() []byte {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *Scan_AttrFilter) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_rq_v1_scan_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc8, 0x06, 0x0a, 0x04, 0x53, 0x63, 0x61, 0x6e,
	...
	0x74, 0x65, 0x72, 0x73, 0x1a, 0x67, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x29,
	...
	0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x60, 0x0a, 0x0a, 0x41, 0x74, 0x74, 0x72,
	...
	0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x6b, 0x0a, 0x09, 0x54, 0x69,
	...
	0x10, 0x07, 0x42, 0x68, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x09, 0x53, 0x63,
	0x61, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x65, 0x71, 0x75, 0x69, 0x65, 0x6d, 0x64, 0x62, 0x2f,
	0x72, 0x65, 0x71, 0x75, 0x69, 0x65, 0x6d, 0x64, 0x62, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f,
	0x2f, 0x72, 0x71, 0x2f, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x56, 0x58, 0x58, 0xaa, 0x02, 0x02, 0x56,
...
var file_rq_v1_scan_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_rq_v1_scan_proto_goTypes = []interface{}{
	...
	(*Scan)(nil),                  // 3: v1.Scan
	(*Scan_Filter)(nil),           // 4: v1.Scan.Filter
	(*Scan_BaseFilter)(nil),       // 5: v1.Scan.BaseFilter
	(*Scan_AttrFilter)(nil),       // 6: v1.Scan.AttrFilter
	(*Scan_TimeRange)(nil),        // 7: v1.Scan.TimeRange
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
}
var file_rq_v1_scan_proto_depIdxs = []int32{
	0, // 0: v1.Scan.scope:type_name -> v1.Scan.SCOPE
	7, // 1: v1.Scan.time_range:type_name -> v1.Scan.TimeRange
	4, // 2: v1.Scan.filters:type_name -> v1.Scan.Filter
	5, // 3: v1.Scan.Filter.base:type_name -> v1.Scan.BaseFilter
	6, // 4: v1.Scan.Filter.attr:type_name -> v1.Scan.AttrFilter
	1, // 5: v1.Scan.BaseFilter.prop:type_name -> v1.Scan.BaseProp
	2, // 6: v1.Scan.AttrFilter.prop:type_name -> v1.Scan.AttributeProp
	8, // 7: v1.Scan.TimeRange.start:type_name -> google.protobuf.Timestamp
	8, // 8: v1.Scan.TimeRange.end:type_name -> google.protobuf.Timestamp
